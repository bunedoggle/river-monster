...
void SendTextMessage()
{
  ...
  delay(100);
  mySerial.println("AT + CMGS = \"1978798xxxx\"");//send sms message, be careful need to add a country code before the cellphone number
  delay(100);
  mySerial.println("11,22,334455");//the content of the message
  delay(100);
